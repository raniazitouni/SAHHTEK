...
VALUES
    ('123456789', 'Ali', 'Ben Ali', '0123456789', '1990-01-01', 'Alger, 12 Rue XYZ', 'ali.benali@example.com', 'cGFzc3dvcmQx','cGFzc3dvcmQx', 1, 'patient'),
    ('987654321', 'Amine', 'Ben Amine', '0987654321', '1985-05-15', 'Oran, 45 Rue ABC', 'amine.benamine@example.com', 'cGFzc3dvcmQy','cGFzc3dvcmQy', 1, 'patient'),
    ('456789012', 'Samir', 'Ben Samir', '0112233445', '2000-09-23', 'Constantine, 32 Rue LMN', 'samir.bensamir@example.com', 'cGFzc3dvcmQz','cGFzc3dvcmQz', 1, 'patient'),
    (NULL, 'Alouane', 'safa', '0112233445', '2004-09-23', 'Constantine, 32 Rue LMN', 'ms_alouane@esi.dz', 'cGFzc3dvcmQz','cGFzc3dvcmQz', 1, 'docteur'),
    (NULL, 'Zitouni', 'rania', '0112233445', '2004-09-23', 'Constantine, 32 Rue LMN', 'mr_zitouni@esi.dz', 'cGFzc3dvcmQz','cGFzc3dvcmQz', 1, 'laborantin'),
    (NULL, 'Hasnaoui', 'sarah', '0112233445', '2004-09-23', 'Constantine, 32 Rue LMN', 'ms_hasnaoui@esi.dz', 'cGFzc3dvcmQz','cGFzc3dvcmQz', 1, 'radiologue'),
    (NULL, 'Zitouni', 'fares', '0112233445', '2004-09-23', 'Constantine, 32 Rue LMN', 'ms_hasnaoui@esi.dz', 'cGFzc3dvcmQz','cGFzc3dvcmQz', 1, 'recepcioniste'),
    (NULL, 'Terkmani', 'Aya', '0112233445', '2000-09-23', 'Constantine, 32 Rue LMN', 'ma_terkmani@esi.dz', 'cGFzc3dvcmQz','cGFzc3dvcmQz', 1, 'infermier'),

    ('321548765', 'Karim', 'Bouaziz', '0156781234', '1992-02-20', 'Blida, 10 Rue ABC', 'karim.bouaziz@example.com', 'cGFzc3dvcmQx', 'cGFzc3dvcmQx', 2, 'patient'),
    (NULL, 'Sofia', 'Khaled', '0192345678', '1990-05-18', 'Oran, 45 Rue JKL', 'sofia.khaled@esi.dz', 'cGFzc3dvcmQz', 'cGFzc3dvcmQz', 2, 'docteur'),
    (NULL, 'Tariq', 'Mebarki', '0189012345', '1980-11-25', 'Alger, 30 Rue MNO', 'tariq.mebarki@esi.dz', 'cGFzc3dvcmQz', 'cGFzc3dvcmQz', 2, 'laborantin'),
    (NULL, 'Yassir', 'Ait Messaoud', '0156789012', '1994-04-10', 'Blida, 55 Rue PQR', 'yassir.aitmessaoud@esi.dz', 'cGFzc3dvcmQz', 'cGFzc3dvcmQz', 2, 'radiologue'),
    (NULL, 'Leila', 'Boudjemaa', '0198765432', '1998-09-17', 'Oran, 18 Rue STU', 'leila.boudjemaa@esi.dz', 'cGFzc3dvcmQz', 'cGFzc3dvcmQz', 2, 'recepcioniste'),
    (NULL, 'Ahmed', 'Benaissa', '0176543210', '1995-06-14', 'Blida, 50 Rue VWX', 'ahmed.benaissa@esi.dz', 'cGFzc3dvcmQz', 'cGFzc3dvcmQz', 2, 'infermier'),

    ('654321098', 'Zohra', 'Guerroudj', '0145612345', '1993-08-30', 'Alger, 12 Rue YZA', 'zohra.guerroudj@example.com', 'cGFzc3dvcmQx', 'cGFzc3dvcmQx', 3, 'patient'),
    (NULL, 'Rachid', 'Boudiaf', '0178901234', '1983-11-22', 'Alger, 60 Rue HIJ', 'rachid.boudiaf@esi.dz', 'cGFzc3dvcmQz', 'cGFzc3dvcmQz', 3, 'docteur'),
    (NULL, 'Amina', 'Khelifi', '0168765432', '1992-01-30', 'Oran, 75 Rue KLM', 'amina.khelifi@esi.dz', 'cGFzc3dvcmQz', 'cGFzc3dvcmQz', 3, 'laborantin'),
    (NULL, 'Mounir', 'Tahar', '0154345678', '1995-05-10', 'Blida, 80 Rue NOP', 'mounir.tahar@esi.dz', 'cGFzc3dvcmQz', 'cGFzc3dvcmQz', 3, 'radiologue'),
    (NULL, 'Khaled', 'Benziane', '0145678901', '2000-09-22', 'Alger, 90 Rue QRS', 'khaled.benziane@esi.dz', 'cGFzc3dvcmQz', 'cGFzc3dvcmQz', 3, 'recepcioniste'),
    (NULL, 'Rami', 'Saidi', '0178923456', '1997-04-15', 'Oran, 100 Rue TUV', 'rami.saidi@esi.dz', 'cGFzc3dvcmQz', 'cGFzc3dvcmQz', 3, 'infermier');
